...
\item {\bfseries p75 A.1.} Consider the following permutations $f$, $g$, and $h$ in $S_6$
	...
	$f^{-1} = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		2 \hspace{6mm} 6 \hspace{6mm} 3 \hspace{6mm} 5 \hspace{6mm} 4 \hspace{6mm} 1
	\end{pmatrix}$
	$g^{-1} = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		3 \hspace{6mm} 1 \hspace{6mm} 2 \hspace{6mm} 6 \hspace{6mm} 5 \hspace{6mm} 4
	\end{pmatrix}$ \\
	$h^{-1} = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		2 \hspace{6mm} 6 \hspace{6mm} 1 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 3
	\end{pmatrix}$ \\
	$f \circ g = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		1 \hspace{6mm} 3 \hspace{6mm} 6 \hspace{6mm} 2 \hspace{6mm} 4 \hspace{6mm} 5
	\end{pmatrix}$
	$g \circ f = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		4 \hspace{6mm} 2 \hspace{6mm} 1 \hspace{6mm} 5 \hspace{6mm} 6 \hspace{6mm} 3
	\end{pmatrix}$
...
\item {\bfseries p75 A.2.} Given p75 A.1, compute the following:
	...
	$g \circ h = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		1 \hspace{6mm} 2 \hspace{6mm} 4 \hspace{6mm} 6 \hspace{6mm} 5 \hspace{6mm} 3
	\end{pmatrix}$
	
	$f \circ (g \circ h) = \begin{pmatrix}
		1 \hspace{6mm} 2 \hspace{6mm} 3 \hspace{6mm} 4 \hspace{6mm} 5 \hspace{6mm} 6 \\
		6 \hspace{6mm} 1 \hspace{6mm} 5 \hspace{6mm} 2 \hspace{6mm} 4 \hspace{6mm} 3
	\end{pmatrix}$
